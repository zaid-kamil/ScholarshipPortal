...
from accounts.models import EducationChoices
...
class Scholarship(models.Model):
    ...
    education_level = models.CharField(choices=EducationChoices.choices,
                                       max_length=2,
                                       default=EducationChoices.BACHELOR_TECH)
    ...
    def is_recommended(self, user):
        if user.profile.education_level >= self.education_level:
            return True
        else:
            return False
